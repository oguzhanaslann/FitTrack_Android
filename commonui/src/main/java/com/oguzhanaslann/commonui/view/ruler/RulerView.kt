...
class RulerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.rulerViewStyle) : View(context, attrs, defStyleAttr) {
    ...
    fun setOnRulerValueChangeListener(onRulerValueChangeListener:OnRulerValueChangeListener) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        markerHeight = markers.map { tempRect.apply { it.getBounds(this) }.height() }.maxOrNull()
                ?: 0 //Marker最大高度
